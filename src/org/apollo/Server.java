...
import org.apollo.net.release.r484.Release484;
...
public final class Server {
	...
	public static void main(String[] args) {
		...
		try {
			server = new Server();
			server.init(Release484.class.getName());
	...
	public void init(String releaseClassName) throws ClassNotFoundException, InstantiationException, IllegalAccessException {
		...
		try {
			context = new ServerContext(release, serviceManager, new Cache(FileStore.open("data/fs/" + release.getReleaseNumber())));
	...
	public void start() throws Exception {
		...
		World.getWorld().init(releaseNo, context.getCache(), mgr);
	}
}
