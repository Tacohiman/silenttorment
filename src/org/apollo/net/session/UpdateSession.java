...
import org.apollo.net.codec.update.verif.MessageResponse;
...
public final class UpdateSession extends Session {
	...
	public void messageReceived(Object message) throws Exception {
		...
		if (message instanceof OnDemandRequest) {
			...
			getChannel().write(new MessageResponse((MessageRequest) message, context.getRelease().getReleaseNumber()).getBuffer());
		} else {
