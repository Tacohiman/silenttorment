...
public final class InterfaceSet {
	...
	public static final int DEFAULT_ROOT_INTERFACE = 548;

	public static int DEFAULT_LAYER_SETTING = 1;
	...
	public void openWindow(InterfaceListener listener, int windowId) {
		...
		interfaces.put(InterfaceType.FULLSCREEN_WINDOW, windowId);

		player.send(new RootInterfaceEvent(windowId));
	}
